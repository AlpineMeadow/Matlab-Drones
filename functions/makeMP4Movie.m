function makeMP4Movie(info, events, eventType)

%This function is called by makeMP4Movies.m.  It will generate a set of
...
movieEndTime = info.movieStartTime + fix(info.movieLength);
...
end  %End of the function makeMP4Movie.m